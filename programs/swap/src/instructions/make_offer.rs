...
use crate::{ transfer_tokens, ANCHOR_DISCRIMINATOR_LENGTH as ANCHOR_DISCRIMINATOR};
...
pub fn send_offered_tokens_to_vault(context: &Context<MakeOffer> , token_a_offered_amount: u64) -> 
Result<()>{
    transfer_tokens(
